...
This project is my seminar work for course MI-LIF at CTU in Prague. It’s very simple Liferay portlet which one can use to search and view information about our courses.

The main aim of this project is:

1. satisfy project targets with regard to used technologies and features, 
2. provide reference example how to easily retrieve data from RESTful service (specifically [KOSapi](https://kosapi.fit.cvut.cz)),
...
* [Spring Framework](http://www.springframework.org/) (Core, Portlet MVC, Web, OXM)
